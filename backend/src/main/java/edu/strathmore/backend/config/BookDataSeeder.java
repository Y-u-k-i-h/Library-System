...
public class BookDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // Clear existing data and force seed new data
    ...
    private void seedBooks() {
        List<Book> books = Arrays.asList(
            ...
            new Book("978-0-452-28423-4", "1984", "George Orwell", "Secker & Warburg", "Fiction", false, "Excellent"),
            ...
            new Book("978-0-14-143955-6", "Wuthering Heights", "Emily Brontë", "Thomas Cautley Newby", "Fiction", false, "Fair"),
            ...
            new Book("978-0-14-143957-0", "Moby Dick", "Herman Melville", "Richard Bentley", "Fiction", false, "Fair"),
            new Book("978-0-553-29335-0", "Foundation", "Isaac Asimov", "Gnome Press", "Fiction", false, "Fair"),
            new Book("978-0-441-56956-9", "Neuromancer", "William Gibson", "Ace Books", "Fiction", true, "Good"),
            new Book("978-0-553-38068-2", "The Martian", "Andy Weir", "Crown Publishers", "Fiction", false, "Good"),
            ...
            new Book("978-0-345-40946-1", "The Name of the Wind", "Patrick Rothfuss", "DAW Books", "Fiction", false, "Good"),
            ...
            new Book("978-0-14-303943-3", "The Silk Roads", "Peter Frankopan", "Bloomsbury Publishing", "Non-Fiction", false, "Good"),
            new Book("978-0-06-073132-6", "Freakonomics", "Steven Levitt", "William Morrow", "Non-Fiction", false, "Good"),
            new Book("978-0-06-112008-4", "The Wealth of Nations", "Adam Smith", "W. Strahan and T. Cadell", "Non-Fiction", true, "Good"),
            new Book("978-1-58542-433-7", "Think and Grow Rich", "Napoleon Hill", "The Ralston Society", "Non-Fiction", false, "Fair"),
            new Book("978-0-307-88789-4", "The Lean Startup", "Eric Ries", "Crown Business", "Non-Fiction", true, "Good"),
            new Book("978-0-375-50411-3", "Zero to One", "Peter Thiel", "Crown Business", "Non-Fiction", false, "Excellent"),
            ...
            new Book("978-0-14-044395-5", "The Nicomachean Ethics", "Aristotle", "Ancient Greece Publishers", "Non-Fiction", false, "Fair"),
            ...
            new Book("978-0-06-256541-5", "Built to Last", "Jim Collins", "HarperBusiness", "Non-Fiction", false, "Excellent"),
            new Book("978-0-307-46374-1", "Rich Dad Poor Dad", "Robert Kiyosaki", "Warner Business Books", "Non-Fiction", true, "Fair"),
            new Book("978-0-375-50412-0", "Homo Deus", "Yuval Noah Harari", "Harvill Secker", "Non-Fiction", false, "Good"),
            ...
            new Book("978-0-470-45840-5", "Discrete Mathematics and Its Applications", "Kenneth Rosen", "McGraw-Hill", "Textbook", false, "Fair"),
            ...
            new Book("978-0-471-40185-7", "Fundamentals of Physics", "David Halliday", "Wiley", "Textbook", false, "Good"),
            ...
            new Book("978-0-321-95721-4", "Organic Chemistry", "Paula Bruice", "Pearson", "Textbook", false, "Fair"),
            ...
            new Book("978-0-321-74841-1", "Principles of Genetics", "Peter Snustad", "Wiley", "Textbook", false, "Fair"),
            ...
            new Book("978-0-13-597871-7", "Database System Concepts", "Abraham Silberschatz", "McGraw-Hill", "Textbook", false, "Fair"),
            ...
            new Book("978-0-321-42733-3", "African History: From Earliest Times to Independence", "Philip Curtin", "Longman", "Textbook", false, "Fair"),
            ...
            new Book("978-0-7432-7358-9", "John Adams", "David McCullough", "Simon & Schuster", "Biography", false, "Good"),
            ...
            new Book("978-0-670-03074-1", "Leonardo da Vinci", "Walter Isaacson", "Simon & Schuster", "Biography", false, "Excellent"),
            ...
            new Book("978-0-670-03075-8", "Benjamin Franklin: An American Life", "Walter Isaacson", "Simon & Schuster", "Biography", false, "Excellent"),
            ...
            new Book("978-0-14-018473-0", "Selected Poems", "Robert Frost", "Henry Holt", "Poetry", false, "Fair"),
            ...
            new Book("978-0-14-042471-8", "The Complete Poems of Maya Angelou", "Maya Angelou", "Random House", "Poetry", false, "Good"),
            ...
            new Book("978-0-471-23094-7", "Climate Change Research Findings", "Environmental Science Group", "Wiley", "Research Paper", false, "Excellent"),
            ...
            new Book("978-0-262-51299-1", "Artificial Intelligence Research Advances", "Stanford AI Lab", "MIT Press", "Research Paper", false, "Excellent"),
            ...
            new Book("978-0-528-84157-2", "Rand McNally World Atlas", "Rand McNally", "Rand McNally", "Atlas/Maps", false, "Fair"),
            ...
            new Book("978-0-7922-6201-3", "National Geographic Kids World Atlas", "National Geographic", "National Geographic", "Atlas/Maps", false, "Good"),
            ...
            new Book("978-0-06-440020-6", "Charlotte's Web", "E.B. White", "Harper & Brothers", "Children's Literature", false, "Excellent"),
            ...
            new Book("978-0-439-13597-4", "The Giving Tree", "Shel Silverstein", "Harper & Row", "Children's Literature", false, "Good"),
            ...
            new Book("978-0-06-440021-3", "Stuart Little", "E.B. White", "Harper & Brothers", "Children's Literature", false, "Fair"),
